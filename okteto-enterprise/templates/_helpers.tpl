...
{{- .Values.ingress.ip -}}
{{- else -}}
{{- printf "$(%s_NGINX_INGRESS_CONTROLLER_SERVICE_HOST)" (regexReplaceAll "-" .Release.Name "_") | upper -}}
{{- end -}}
{{- else -}}
{{- required "If 'nginx-ingress' is not enabled you need to set the value of '.Values.ingress.ip'" .Values.ingress.ip -}}
{{- end -}}
{{- end -}}
